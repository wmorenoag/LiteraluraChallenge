package com.aluraLatam.literaluraChalllenge.principal;

import com.aluraLatam.literaluraChalllenge.dto.AutorDTO;
import com.aluraLatam.literaluraChalllenge.dto.LibroDTO;
import com.aluraLatam.literaluraChalllenge.dto.RespuestaLibrosDTO;
import com.aluraLatam.literaluraChalllenge.model.Autor;
import com.aluraLatam.literaluraChalllenge.model.Libro;
import com.aluraLatam.literaluraChalllenge.service.AutorService;
import com.aluraLatam.literaluraChalllenge.service.ConsumoAPI;
import com.aluraLatam.literaluraChalllenge.service.ConvierteDatos;
import com.aluraLatam.literaluraChalllenge.service.LibroService;
            ...
            switch(opcion){
                        ...
                        if(librosDTO.isEmpty()){
                            ...
                            for (LibroDTO libroDTO : librosDTO) {
                                if (libroDTO.getTitulo().equalsIgnoreCase(titulo)) {
                                    Optional<Libro> libroExistente = libroService.obtenerLibroTitulo(titulo);
                                    if (libroExistente.isPresent()) {
                                        ...
                                        Autor autor = autorService.obtenerAutorNombre(primerAutorDTO.getNombre())
                                                .orElseGet(() -> {
                ...
                case 5:
                    ...
                    if("es".equalsIgnoreCase(idioma) || "en".equalsIgnoreCase(idioma) || "fr".equalsIgnoreCase(idioma) || "pt".equalsIgnoreCase(idioma)) {
                        libroService.listarLibrosIdioma(idioma).forEach(libro -> {
                            System.out.println("------LIBRO--------");
                            System.out.println("Título: " + libro.getTitulo());
                            System.out.println("Autor: " + (libro.getAutor() != null ? libro.getAutor().getNombre() : "Desconocido"));
                            System.out.println("Idioma: " + libro.getIdioma());
